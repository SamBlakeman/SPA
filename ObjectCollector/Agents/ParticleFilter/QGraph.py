...
class QGraph(object):
    def __init__(self, input_dim, num_actions, discount_factor, directory, vgg16_npy_path):
        ...
        with self.graph.as_default():
            ...
            with tf.variable_scope('ac'):
                ...
                self.hidden1 = slim.flatten(self.pool5_attention)
    ...
    def SelectAction(self, X, rnn_state, attention_weights):
    ...
    def GetValues(self, X, rnn_state, attention_weights):
    ...
    def Train(self, rollout, bootstrap_value, attention_weights):
    ...
    def GetLosses(self, rollout, bootstrap_value, attention_weights):
